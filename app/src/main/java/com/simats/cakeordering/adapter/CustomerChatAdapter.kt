...
/**
 * Chat adapter for Customer view - customer messages appear on right (sent), baker messages on left (received)
 */
class CustomerChatAdapter(
    ...
    override fun getItemViewType(position: Int): Int {
        // For customer view: customer messages are SENT, baker messages are RECEIVED
        return if (messages[position].sender_type == "customer") {
            VIEW_TYPE_SENT
        } else {
            VIEW_TYPE_RECEIVED
        }
